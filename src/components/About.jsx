        ...
        >
            <div className='container mx-0 px-6'>
                ...
                <h2 className='text-3xl font-bold text-center mb-4'>About
                    <span className='text-cyan-400 ml-1.5'>Me</span>
                </h2>
                <p className='text-gray-400 text-center max-w-2xl mx-auto mb-6'>Get to know more about my background and passion</p>
                {/* image + my journey  */}
                <div className='flex flex-col md:flex-row items-center gap-12'>
                    ...
                    >
                        <div className='rounded-2xl p-8'>
                            ...
                            <p className='text-gray-300 mb-6'>I'm a passionate full-stack developer who started my tech journey from a diploma background and worked my way into B.Tech (CSE) with a strong focus on real-world development. I began by building simple frontend projects, and over time, I mastered the MERN stack—creating full applications like e-commerce systems, payment integrations, and clones of major platforms.</p>
